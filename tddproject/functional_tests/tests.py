...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_can_start_a_todo_list(self):
        ...
        inputbox.send_keys("TDD Training")
        # When she hits enter, the page updates, and now the page lists
        # "1: TDD Training" as an item in a to-do list table
        inputbox.send_keys(Keys.ENTER)
        self.wait_for_row_in_list_table("1: TDD Training")

        # There is still a text box inviting her to add another item.
        # She enters "Read TDD Documentation"
        ...
        self.wait_for_row_in_list_table("1: TDD Training")
        self.wait_for_row_in_list_table("2: Read TDD Documentation")
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        self.assertNotIn("TDD Training", page_text)
